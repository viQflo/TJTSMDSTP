    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            ...
            case "view":
                ...
                BoardDTO post = boardDAO.getPostByIdx(postIdx);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            case "write":
                ...
                BoardDTO newPost = new BoardDTO(0, title, content, file, null, 0, 0, email, null);
            ...
            case "update":
                ...
                BoardDTO updatedPost = new BoardDTO(postIdx, updatedTitle, updatedContent, updatedFile, null, 0, 0, null, null);
